...
public class MODULE4 extends javax.swing.JFrame {
 String n,t,c,e,m,ty,f;
    ...
    public MODULE4() {
        ...
        ResultSet rs;
            rs = st.executeQuery("select Name, course, email,  mob_num, timing, fees, type from tab1");
        while(rs.next())
        {
            n=rs.getString("Name");
            c=rs.getString("course");
            e=rs.getString("email");
             m=rs.getString("mob_num");
            t=rs.getString("timing");
            
           f=rs.getString("fees");
            ty=rs.getString("type");
            
            System.out.println(n+c+t+e+m+ty+f);
    ...
    private void initComponents() {
        ...
        jLabel11.setText("REGISTERED SUCCESSFULLY");
